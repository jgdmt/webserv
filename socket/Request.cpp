    ...
    while(t != EMPTY)
    {
        switch (t)
        {
            ...
            case CONTENT_LENGTH:
                ...
                std::cout << "ERROR CL " << _error << "\n";
			default:
                std::cout << "ATTENTION DEFAULT\n";
                break;
        }
